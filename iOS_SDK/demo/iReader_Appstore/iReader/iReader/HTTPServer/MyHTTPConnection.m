...
- (void) processStartOfPartWithHeader:(MultipartMessageHeader*) header {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"beginWithFile" object:filename];
...
- (void) processContent:(NSData*) data WithHeader:(MultipartMessageHeader*) header 
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"didReceiveData" object:@{@"data": data, @"fileName": filename}];
}
...
- (void) processEndOfPartWithHeader:(MultipartMessageHeader*) header
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"endReceiveFromFile" object:filename];
}
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"deliverEnd" object:nil];
}
