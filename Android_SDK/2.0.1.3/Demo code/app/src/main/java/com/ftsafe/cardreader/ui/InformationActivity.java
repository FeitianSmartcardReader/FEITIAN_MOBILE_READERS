...
public class InformationActivity extends BaseActivity implements View.OnClickListener{
    ...
    private ToggleButton ToggleButton1,ToggleButton2; // Button listeners
    ...
    private void initView() {
        ...
        if (isAutoConnect) {
            // If auto-connect has been set previously, then below lines are needed to change UI
...
//                startActivity(intent);
    ...
    String readerGetSerialNum() {
        ...
        int[] length = new int[1];
        try {
            mFtReader.readerGetSerialNum(0,length,outData);
        } catch (FTException e) {
            e.printStackTrace();
        }
