...
using ObjCRuntime;
[assembly: LinkWith("libiRockey301_ccid.a",  SmartLink = true, ForceLoad = true,Frameworks = "CoreBluetooth ExternalAccessory CoreFoundation Foundation UIKit GameKit MessageUI StoreKit", IsCxx = true)]
