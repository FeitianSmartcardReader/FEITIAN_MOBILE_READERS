...
namespace Com.Ftsafe.Comm.Bt4 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']"
	[global::Android.Runtime.Register ("com/ftsafe/comm/bt4/BT4", DoNotGenerateAcw=true)]
	public partial class BT4 : global::Java.Lang.Object, global::Com.Ftsafe.ReaderScheme.IFTReaderInf {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ftsafe/comm/bt4/BT4", typeof (BT4));
		...
		protected BT4 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/constructor[@name='BT4' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.ftsafe.comm.CommBase.CommCallback']]"
		[Register (".ctor", "(Landroid/content/Context;Lcom/ftsafe/comm/CommBase$CommCallback;)V", "")]
		public unsafe BT4 (global::Android.Content.Context context, global::Com.Ftsafe.Comm.CommBase.ICommCallback @callback) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Ftsafe.Comm.Bt4.BT4> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Ft_close ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='ft_close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='ft_control' and count(parameter)=6 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='ft_find' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='ft_open' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='ft_recv' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='ft_send' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='byte[]'] and parameter[3][@type='int']]"
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Ftsafe.Comm.Bt4.BT4> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewArray (__this.GetBleFirmwareVersion ());
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='getBleFirmwareVersion' and count(parameter)=0]"
		[Register ("getBleFirmwareVersion", "()[B", "GetGetBleFirmwareVersionHandler")]
		public virtual unsafe byte[] GetBleFirmwareVersion ()
		{
			const string __id = "getBleFirmwareVersion.()[B";
			try {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='isFtExist' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ftsafe.comm.bt4']/class[@name='BT4']/method[@name='stopScan' and count(parameter)=0]"
