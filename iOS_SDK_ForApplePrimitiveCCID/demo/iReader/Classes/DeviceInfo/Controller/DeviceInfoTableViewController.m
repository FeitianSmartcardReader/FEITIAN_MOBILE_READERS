...
//            self.myTableView.contentInset = UIEdgeInsetsMake(64 + 24, 0, 15, 0);
...
//        }
    ...
    [self.navigationController.navigationBar setBarTintColor:commonColor];
        if (@available(iOS 13.0, *)) {
            ...
            appearance.backgroundColor = commonColor;
...
//            appearance.titleTextAttributes = @{NSForegroundColorAttributeName: [UIColor whiteColor],NSFontAttributeName:IOS_VERSION_5_OR_FONT_Semibold(18)};
...
//    [self.navigationController.navigationBar setBarTintColor:[UIColor orangeColor]];
    ...
    UIButton * _backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
   ...
   [_backButton setImage:[UIImage imageNamed:@"1_back"] forState:UIControlStateNormal];
    [_backButton addTarget:self action:@selector(clickBackAction) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *_leftNavBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:_backButton];
   [self.navigationItem setLeftBarButtonItem:_leftNavBarButtonItem];
...
//            [self addModel:hardwareRevision title:@"Hardware Version"];
    ...
    if([FTDeviceType getDeviceType] != LINE_TYPEC){
        //Bluetooth ID
